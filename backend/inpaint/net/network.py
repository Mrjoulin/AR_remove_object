...
# Local imports
from backend.inpaint.net.ops import random_bbox, bbox2mask, local_patch
from backend.inpaint.net.ops import priority_loss_mask
from backend.inpaint.net.ops import id_mrf_reg
from backend.inpaint.net.ops import gan_wgan_loss, gradients_penalty, random_interpolates
from backend.inpaint.net.ops import free_form_mask_tf
