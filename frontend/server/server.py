...
# local import
#from backend.source import get_image_inpaint, test_objects
...
class VideoTransformTrack(VideoStreamTrack):
    ...
    async def recv(self):
        ...
        if self.transform == "inpaint":
            ...
            objects, class_objects = test_objects()
            new_img = get_image_inpaint(img, objects)
...
async def index(request):
    content = open(os.path.join(ROOT, "webrtc.html"), "r").read()
